...
public:
    ...
    static std::shared_ptr<SymbolicExpr> makePower(std::shared_ptr<SymbolicExpr> base,
...
public:
    ...
    // Transforms
    std::shared_ptr<SymbolicExpr> laplace(std::shared_ptr<SymbolicExpr> expr, const std::string& t,
                                          const std::string& s);
    std::shared_ptr<SymbolicExpr> inverseLaplace(std::shared_ptr<SymbolicExpr> expr, const std::string& s,
                                                 const std::string& t);
    ...
    jacobian(const std::vector<std::shared_ptr<SymbolicExpr>>& exprs, const std::vector<std::string>& vars);

    // PDE Support
    std::shared_ptr<SymbolicExpr> pde_register(std::shared_ptr<SymbolicExpr> eq, const std::vector<std::string>& vars);
    std::shared_ptr<SymbolicExpr> partial_differentiate(std::shared_ptr<SymbolicExpr> expr, const std::string& var,
                                                        int order);
