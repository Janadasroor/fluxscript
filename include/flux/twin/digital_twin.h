...
public:
    // Electrical systems
    static std::function<SystemState(double, const SystemState&)> createRLCCircuit(double R, double L, double C);

    static std::function<SystemState(double, const SystemState&)> createPowerConverter(const std::string& topology);

    // Thermal systems
    static std::function<SystemState(double, const SystemState&)> createThermalModel(double mass, double specificHeat,
                                                                                     double h);

    // Mechanical systems
    static std::function<SystemState(double, const SystemState&)> createMassSpringDamper(double m, double c, double k);

    // Battery model
    static std::function<SystemState(double, const SystemState&)> createBatteryModel(double capacity,
