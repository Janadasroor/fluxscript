...
public:
    ...
    // Add custom rules
    void addRule(const std::string& name, const std::string& expression, IssueSeverity severity);
...
public:
    ...
    std::vector<FixSuggestion> optimizeFor(const std::string& objective, const std::vector<std::string>& constraints);
