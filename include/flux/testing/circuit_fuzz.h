...
struct FuzzConfig
{
    ...
    FuzzConfig() : iterations(100), mutationRate(0.5), mutationMagnitude(0.2), randomizeOrder(false), timeoutMs(5000) {}
};
...
struct FuzzSummary
{
    ...
    FuzzSummary()
        : totalTests(0), passed(0), failed(0), crashed(0), unstable(0), passRate(0), avgExecutionTime(0),
          worstCaseTime(0)
    {
    }
