...
struct FileOperationResult
{
    ...
    static FileOperationResult ok(const QString& message = QString()) { return {true, message, QString()}; }

    static FileOperationResult error(const QString& message) { return {false, message, QString()}; }
};
...
public:
     ...
     */
    Q_INVOKABLE QStringList listDirectory(const QString& path, const QString& filter = QString(),
                                          bool includeHidden = false);

    /**
     * @brief Get all files in directory
     */
    Q_INVOKABLE QStringList getFiles(const QString& path, const QString& filter = QString(), bool recursive = false);
     ...
     */
    Q_INVOKABLE QStringList searchFiles(const QString& directory, const QString& pattern, bool recursive = true);

    /**
     * @brief Search for files containing text
     */
    Q_INVOKABLE QStringList searchContent(const QString& directory, const QString& text,
                                          const QString& fileFilter = QString(), bool caseSensitive = false);
