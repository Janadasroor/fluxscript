...
private:
    ...
    InstallStatus installInternal(const std::string& name, const std::string& version,
                                  std::vector<std::string>& installed);
    bool resolveDependencies(const std::string& name, const std::string& version,
                             std::vector<std::string>& dependencies);
    bool downloadPackage(const std::string& name, const std::string& version, const std::string& destPath);
