...
public:
    ...
    std::map<std::string, std::complex<double>> acSensitivity(const std::string& output, double frequency);
    std::map<std::string, double> transientSensitivity(const std::string& output, double time);
...
public:
    ...
    // Define corners
    void addCorner(const std::string& name, const std::map<std::string, double>& parameters);
