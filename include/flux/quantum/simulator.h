...
public:
    ...
    static QuantumGate applyToQubits(const QuantumGate& gate, int totalQubits, const std::vector<int>& targetQubits);
};
...
public:
    ...
    void addGate(const std::string& name, const std::vector<int>& qubits, const std::vector<double>& params = {});
...
public:
    ...
    // Phase estimation
    static QuantumCircuit quantumPhaseEstimation(const QuantumGate& unitary, int precisionQubits);
    ...
    static QuantumCircuit qaoa(const std::vector<double>& gamma, const std::vector<double>& beta, int numQubits);
...
public:
    ...
    static std::map<std::string, double> jordanWignerTransform(const MolecularHamiltonian& hamiltonian);

    // VQE for molecular ground state
    static double vqeGroundState(const MolecularHamiltonian& hamiltonian, int numQubits, int maxIterations);
