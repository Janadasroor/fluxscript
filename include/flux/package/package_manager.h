...
private:
    ...
    void buildDependencyTree(const std::string& packageName, const std::string& prefix, std::vector<std::string>& tree);
...
private:
    static bool matchRange(const PackageVersion& version, const PackageVersion& min, const PackageVersion& max);
};
