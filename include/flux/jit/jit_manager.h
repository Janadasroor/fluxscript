...
public:
    ...
    bool registerComponent(const std::string& name, const std::string& source_code, int num_inputs, int num_outputs,
    ...
    bool recompileComponent(const std::string& name, const std::string& new_source, std::string* error = nullptr);
    bool hotReloadComponent(const std::string& name, const std::string& new_source, std::string* error = nullptr);

    // Simulation control
    bool initializeSimulation();
    bool stepSimulation(double time, double dt);
    bool evaluateComponent(const std::string& name, double time, double dt, const double* inputs, double* outputs);
    ...
    bool registerSignalGenerator(const std::string& name, const std::string& source_code, std::string* error = nullptr);
    double evaluateSignal(const std::string& name, double time);
    std::vector<double> generateWaveform(const std::string& name, double t_start, double t_stop, double sample_rate,
                                         std::string* error = nullptr);
    ...
    std::vector<double> getProbeData(const std::string& component_name, const std::string& signal_name) const;
