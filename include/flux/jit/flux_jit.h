...
struct FunctionProfile {
    ...
    void recordCall(double elapsedUs) {
        ...
        if (elapsedUs < minCpuTimeUs) minCpuTimeUs = elapsedUs;
        if (elapsedUs > maxCpuTimeUs) maxCpuTimeUs = elapsedUs;
    }

    double averageTimeUs() const {
        return totalCalls > 0 ? totalCpuTimeUs / totalCalls : 0.0;
    }
};
...
public:
    ...
    enum class Hotness { Cold, Warm, Hot, VeryHot };
...
public:
    ...
    OptimizationLevel findBestOptLevel(
        const std::string& name,
