...
public:
    ...
    // Run validation
    CircuitValidationResult validateCircuit(const ValidationConfig& config, const std::string& fluxscript_netlist,
                                            const std::string& reference_netlist);

    // Compare specific measurements
    std::vector<MeasurementComparison> compareMeasurements(const std::map<std::string, double>& fluxscript_results,
    ...
    // Batch validation
    std::vector<CircuitValidationResult> validateCircuitBatch(const std::vector<ValidationConfig>& configs,
    ...
    bool cacheReferenceResult(const std::string& circuit_key, const std::map<std::string, double>& result);
