...
InstallStatus PackageManager::install(const std::string& name, const std::string& version)
{
    std::cout << "\n" << std::endl;
...
InstallStatus PackageManager::installInternal(const std::string& name, const std::string& version,
                                              std::vector<std::string>& installed)
{
...
bool PackageManager::resolveDependencies(const std::string& name, const std::string& version,
                                         std::vector<std::string>& dependencies)
{
...
bool PackageManager::downloadPackage(const std::string& name, const std::string& version, const std::string& destPath)
{
