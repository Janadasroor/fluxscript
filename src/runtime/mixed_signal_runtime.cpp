...
static const std::map<std::string, double> g_unitScales = {
    {"V", 1.0}, {"mV", 1e-3}, {"kV", 1e3}, {"μV", 1e-6}, {"uV", 1e-6},
    {"A", 1.0}, {"mA", 1e-3}, {"μA", 1e-6}, {"uA", 1e-6}, {"nA", 1e-9},
    {"Ω", 1.0}, {"kΩ", 1e3}, {"MΩ", 1e6}, {"mΩ", 1e-3},
    {"F", 1.0}, {"μF", 1e-6}, {"uF", 1e-6}, {"nF", 1e-9}, {"pF", 1e-12},
    {"H", 1.0}, {"mH", 1e-3}, {"μH", 1e-6}, {"uH", 1e-6},
    {"Hz", 1.0}, {"kHz", 1e3}, {"MHz", 1e6}, {"GHz", 1e9},
    {"s", 1.0}, {"ms", 1e-3}, {"μs", 1e-6}, {"us", 1e-6}, {"ns", 1e-9}, {"ps", 1e-12},
