...
TypedValue SubcktInstanceAST::codegen(CodegenContext& context) {
    ...
    llvm::Value* MsgPtr = context.Builder.CreateGlobalStringPtr(spiceLine, "subckt_instance");
...
TypedValue VoltageAccessAST::codegen(CodegenContext& context) {
    ...
    llvm::Value* NodePPtr = context.Builder.CreateGlobalStringPtr(NodeP, "node_p");
    llvm::Value* NodeNPtr = context.Builder.CreateGlobalStringPtr(NodeN, "node_n");
...
TypedValue CurrentAccessAST::codegen(CodegenContext& context) {
    ...
    llvm::Value* BranchPtr = context.Builder.CreateGlobalStringPtr(Branch, "branch");
...
TypedValue PinMapAST::codegen(CodegenContext& context) {
    ...
    llvm::Value* MsgPtr = context.Builder.CreateGlobalStringPtr(
        "Pin mapping generated", "pinmap_msg");
    llvm::Function* PrintF = context.TheModule->getFunction("println_string");
    if (PrintF) {
        context.Builder.CreateCall(PrintF, {MsgPtr});
    }
