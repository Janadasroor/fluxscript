...
std::string ADeviceExprAST::deviceTypeToString(ADeviceType type) {
    switch (type) {
        case ADeviceType::BUF:     return "BUF";
        case ADeviceType::NOT:     return "NOT";
        case ADeviceType::AND:     return "AND";
        case ADeviceType::OR:      return "OR";
        case ADeviceType::NAND:    return "NAND";
        case ADeviceType::NOR:     return "NOR";
        case ADeviceType::XOR:     return "XOR";
        case ADeviceType::XNOR:    return "XNOR";
        case ADeviceType::SCHMITT: return "SCHMITT";
        case ADeviceType::DFF:     return "DFF";
        case ADeviceType::JKFF:    return "JKFF";
        case ADeviceType::SRFF:    return "SRFF";
        case ADeviceType::DLATCH:  return "DLATCH";
        case ADeviceType::COUNTER: return "COUNTER";
        default:                   return "BUF";
    }
}
...
std::string ADeviceExprAST::deviceTypeToModelName(ADeviceType type) {
    switch (type) {
        case ADeviceType::BUF:     return "d_buffer";
        case ADeviceType::NOT:     return "d_inverter";
        case ADeviceType::AND:     return "d_and";
        case ADeviceType::OR:      return "d_or";
        case ADeviceType::NAND:    return "d_nand";
        case ADeviceType::NOR:     return "d_nor";
        case ADeviceType::XOR:     return "d_xor";
        case ADeviceType::XNOR:    return "d_xnor";
        case ADeviceType::SCHMITT: return "d_buffer";
        case ADeviceType::DFF:     return "d_dff";
        case ADeviceType::JKFF:    return "d_jkff";
        case ADeviceType::SRFF:    return "d_srff";
        case ADeviceType::DLATCH:  return "d_dlatch";
        case ADeviceType::COUNTER: return "d_fdiv";
        default:                   return "d_buffer";
    }
}
...
TypedValue ADeviceExprAST::codegen(CodegenContext& context) {
    ...
    if (!RegisterADevice) {
        ...
        RegisterADevice = llvm::Function::Create(
            llvm::FunctionType::get(VoidTy, {CharPtrTy, Int32Ty, CharPtrTy, CharPtrTy}, true),
    ...
    return TypedValue(context.Builder.CreateCall(RegisterADevice, {
        context.Builder.CreateGlobalStringPtr(InstanceName),
        context.Builder.getInt32(static_cast<int>(DeviceType)),
        context.Builder.CreateGlobalStringPtr(inputStr),
        context.Builder.CreateGlobalStringPtr(outputStr)
    }), TypeKind::Void);
}
...
TypedValue WaveFileExprAST::codegen(CodegenContext& context) {
    ...
    return TypedValue(context.Builder.CreateCall(RegisterWaveFile, {
        context.Builder.CreateGlobalStringPtr(InstanceName),
        context.Builder.CreateGlobalStringPtr(PositiveNode),
        context.Builder.CreateGlobalStringPtr(NegativeNode),
        context.Builder.CreateGlobalStringPtr(FilePath),
